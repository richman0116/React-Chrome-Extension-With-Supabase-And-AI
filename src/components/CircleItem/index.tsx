...
const CircleItem = ({ circle }: CircleItemInterface) => {
  ...
  return (
    <a
      ...
      rel="noreferrer"
      target="_blank"
      className="circles-item px-4 my-2 h-20 transition-transform transform hover:cursor-pointer hover:bg-slate-50 flex gap-5 items-center"
    >
      <div className="rounded-full min-w-[80px] h-20 bg-gray-300" />
